...
static struct msm_gpiomux_config a66_er3_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
...
//ASUS_BSP+++ larry lai : for ER3 HW change, todo:need to config to GP10_WL_HOST_WAKE
	{
		.gpio = 10,
		.settings = {
...
//ASUS_BSP--- larry lai : for ER3 HW change	
//joe1_++
	{
...
//ASUS_BSP --- Stimber "[A60K][8M][NA][Others]Full porting for 8M camera with ISP"
    //[psensor]Add cm3623 support
        ...
        },
        {
                .gpio = 50,
                .settings = {
                        [GPIOMUX_ACTIVE]    = &hdmi_active_3_cfg,//Mickey
                        [GPIOMUX_SUSPENDED] = &NC_cfg,
                },
        },
        {
...
//ASUS_BSP+++ larry lai : for ER3 HW change, todo:need to config to BT_PCM_OUT	        
        {
                .gpio = 63,
                .settings = {
                    [GPIOMUX_SUSPENDED] = &NC_cfg,
...
//+++ASUS_BSP Peter_lu : for set charging current to 1A..........................................
#ifdef CONFIG_MAXIM_8934_CHARGER
static struct msm_gpiomux_config a66_msm8960_charger_high_configs[] = {
        {
                .gpio = 97,
                .settings = {
...
static struct msm_gpiomux_config a66_msm8960_charger_low_configs[] = {
        {
                .gpio = 97,
                .settings = {
					[GPIOMUX_ACTIVE]    = &O_L_cfg,
