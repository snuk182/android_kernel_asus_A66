#ifndef __A66_ER2_GPIO_PINMUX_H
#define __A66_ER2_GPIO_PINMUX_H

#include "a60k_gpio_pinmux_setting.h"

static struct msm_gpiomux_config a66_er2_msm8960_gpio_configs[] = {
        {
                .gpio = 0,
                .settings = {
...
//ASUS_BSP +++ Stimber "[A60K][8M][NA][Others]Full porting for 8M camera with ISP"
	{
		...
		.settings = {
			...
			[GPIOMUX_SUSPENDED] = &cam_settings[9],//&cam_settings[0],
		},
	},
//ASUS_BSP --- Stimber "[A60K][8M][NA][Others]Full porting for 8M camera with ISP"
	{
