...
//ASUS_BSP +++ Stimber "[A60K][8M][NA][Others]Full porting for 8M camera with ISP"
#define CFG_ISP_AF_START		59
#define CFG_GET_ISP_AF_RESULT		60
#define CFG_SET_ISP_LED_MODE		61	//ASUS_BSP LiJen "[A60K][8M][NA][Others]implement LED/Flash mode in 8M camera with ISP"
#define CFG_SET_ISP_EFFECT_MODE	62   //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement Effect mode in 8M camera with ISP"	
#define CFG_SET_ISP_WB_MODE	63 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement WB mode in 8M camera with ISP"	
#define CFG_SET_ISP_EV_MODE	64 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement EV mode in 8M camera with ISP"
#define CFG_SET_ISP_SCENE_MODE	65 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement Scene mode in 8M camera with ISP"	
#define CFG_SET_ISP_CAF_MODE	66 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement CAF mode in 8M camera with ISP"	
#define CFG_SET_ISP_AECLOCK_MODE	67 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement AEC Lock mode in 8M camera with ISP"
#define CFG_SET_ISP_AWBLOCK_MODE	68 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement AWB Lock mode in 8M camera with ISP"
#define CFG_SET_ISP_ISO_MODE	69 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement ISO mode in 8M camera with ISP"
#define CFG_SET_ISP_FLICKER_MODE	70 //ASUS_BSP LiJen "[A60K][8M][NA][Others]implement ISO mode in 8M camera with ISP"
#define CFG_GET_ISP_EXIF		71	//ASUS_BSP Stimber "[A60K][8M][NA][Other] Implement EXIF info for 8M camera with ISP"
#define CFG_MAX			72
