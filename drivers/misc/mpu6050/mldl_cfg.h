...
int inv_mpu_suspend_6050(struct mldl_cfg *mldl_cfg,
		    ...
		    void *pressure_handle,
		    unsigned long sensors);
int inv_mpu_set_firmware_6050(struct mldl_cfg *mldl_cfg,
			 void *mlsl_handle,
				     ...
				     void *accel_handle, unsigned char *data)
{
	...
	return inv_mpu_slave_read_6050(
				       ...
				       struct ext_slave_config *data)
{
	...
	return inv_mpu_slave_config_6050(
					   ...
					   struct ext_slave_config *data)
{
	...
	return inv_mpu_get_slave_config_6050(
		mldl_cfg, gyro_handle, accel_handle, data,
		mldl_cfg->slave[EXT_SLAVE_TYPE_ACCEL],
		mldl_cfg->pdata_slave[EXT_SLAVE_TYPE_ACCEL]);
}
