...
<<<<<<< HEAD
	...
	int rx_buf_size;
||||||| parent of bdb7bf68bfb... msm_serial_hs: Fix synchronization between ADM and UART Cores
=======
	bool termios_in_progress;
>>>>>>> bdb7bf68bfb... msm_serial_hs: Fix synchronization between ADM and UART Cores
};
